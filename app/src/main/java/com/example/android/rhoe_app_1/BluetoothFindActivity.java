...
public abstract class BluetoothFindActivity extends ExpandableListActivity implements DiscoveryHandler {

    protected List<String> discoveredPrinters = null;
    private ZebraExpandableListAdapter mExpListAdapter;

    public BluetoothFindActivity() {
        super();
    }
    ...
    public void discoveryFinished() {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(BluetoothFindActivity.this, " Discovered " + mExpListAdapter.getGroupCount() + " printers", Toast.LENGTH_SHORT).show();
    ...
    private class ZebraExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
            LayoutInflater inflater = (LayoutInflater) BluetoothFindActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
